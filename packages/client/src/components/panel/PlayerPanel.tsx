...
export function PlayerPanel({ player, isActive, isMe, board, longestRoadOwner, largestArmyOwner }: Props) {
  ...
  return (
    <div style={{
      ...
      {/* Header row: color dot · name · active arrow · VP */}
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: '#7a6d5e', marginBottom: 4 }}>
        ...
        {player.hasLongestRoad && (
          <span style={{ color: '#b5550a', fontWeight: 'bold' }} title="Longest Road">🛤️ LR</span>
        )}
        {player.hasLargestArmy && (
          <span style={{ color: '#c0392b', fontWeight: 'bold' }} title="Largest Army">⚔️ LA</span>
        )}
      </div>
